...
public class DualListViews extends Application {
	...
	public void start(Stage primaryStage) throws Exception{
		...
		gridPane.add(coursesToTakeLbl, 2, 0);

		String[] courses = {"CSE110", "CSE 118", "CSE 148", "CSE 218", "CSE 222", "CSE 248"};

		ObservableList<String> coursesToTakeList = FXCollections.observableArrayList(Arrays.asList(courses)); // Must turn arrays into list
